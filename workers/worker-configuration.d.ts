/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=../wrangler.toml --env-interface=CloudflareBindings` (hash: 7a45d1f183a683ac1ef73728745b5062)
// Runtime types generated with workerd@1.20260908.1 2026-09-10 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	DB: D1Database;
	ASSETS: Fetcher;
	USERNAME: "admin";
	AGENT: DurableObjectNamespace<import("./src/index").AgentTurnDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AgentTurnDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "USERNAME">> {}
}
